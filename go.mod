...
require (
	...
	gitlab.com/rackn/godmi v0.6.3 // indirect
	gitlab.com/rackn/gohai v0.7.16 // indirect
	gitlab.com/rackn/logger v1.3.1 // indirect
	gitlab.com/rackn/rofs v0.6.2 // indirect
	gitlab.com/rackn/seekable-zstd v0.9.0 // indirect
	gitlab.com/rackn/simplecache v0.1.0 // indirect
